...
pub mod handshaking {
  ...
  pub fn handshake(data: &mut Vec<u8>, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
...
use super::*;
  ...
  pub fn login_start(data: &mut Vec<u8>, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
    ...
    lib::utils::send_packet(stream, lib::packets::clientbound::login::LoginSuccess::get_id(), lib::packets::clientbound::login::LoginSuccess {
  ...
  pub fn login_acknowledged(stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
    ...
    lib::utils::send_packet(stream, lib::packets::clientbound::configuration::ClientboundKnownPacks::get_id(), lib::packets::clientbound::configuration::ClientboundKnownPacks {
...
use super::*;
  ...
  pub fn serverbound_known_packets(stream: &mut TcpStream) -> Result<(), Box<dyn Error>> {
    lib::utils::send_packet(stream, lib::packets::clientbound::configuration::RegistryData::get_id(), lib::packets::clientbound::configuration::RegistryData {
  ...
  pub fn acknowledge_finish_configuration(stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>, game: &mut Game, connection_streams: &mut HashMap<SocketAddr, TcpStream>) -> Result<(), Box<dyn Error>> {
    ...
    lib::utils::send_packet(stream, lib::packets::clientbound::play::GameEvent::get_id(), lib::packets::clientbound::play::GameEvent {
      event: 13,
      value: 0.0,
    }.try_into().unwrap())?;
    ...
    for player in &game.players {
      ...
      lib::utils::send_packet(stream, lib::packets::clientbound::play::SetEntityMetadata::get_id(), lib::packets::clientbound::play::SetEntityMetadata {
        entity_id: player.entity_id,
        metadata: vec![
    ...
    for player in &game.players {
      if stream.peer_addr().is_ok() && player.peer_socket_address == stream.peer_addr().unwrap() {
        continue;
      }
      ...
      lib::utils::send_packet(player_stream, lib::packets::clientbound::play::SetEntityMetadata::get_id(), lib::packets::clientbound::play::SetEntityMetadata {
        entity_id: current_player.entity_id,
        metadata: vec![
          lib::packets::clientbound::play::EntityMetadata {
            index: 9,
    ...
    std::thread::spawn(move || {
      loop {
        ...
        if lib::utils::send_packet(&stream_clone, lib::packets::clientbound::play::ClientboundKeepAlive::get_id(), lib::packets::clientbound::play::ClientboundKeepAlive {
...
pub mod play {
  ...
  pub fn set_player_position(data: &mut Vec<u8>, game: &mut Game, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>, connection_streams: &mut HashMap<SocketAddr, TcpStream>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn set_player_position_and_rotation(data: &mut Vec<u8>, game: &mut Game, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>, connection_streams: &mut HashMap<SocketAddr, TcpStream>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn set_player_rotation(data: &mut Vec<u8>, game: &mut Game, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>, connection_streams: &mut HashMap<SocketAddr, TcpStream>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn confirm_teleportation(data: &mut Vec<u8>, game: &mut Game, stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn set_creative_mode_slot(data: &mut Vec<u8>, stream: &mut TcpStream, game: &mut Game, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn set_held_item(data: &mut Vec<u8>, stream: &mut TcpStream, game: &mut Game, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
  ...
  pub fn player_action(data: &mut Vec<u8>, stream: &mut TcpStream, connection_streams: &mut HashMap<SocketAddr, TcpStream>, game: &mut Game) -> Result<(), Box<dyn Error>> {
  ...
  pub fn use_item_on(data: &mut Vec<u8>, stream: &mut TcpStream, connection_streams: &mut HashMap<SocketAddr, TcpStream>, game: &mut Game, connections: &mut HashMap<SocketAddr, Connection>) -> Result<(), Box<dyn Error>> {
...
pub fn update_players(connection_streams: &mut HashMap<SocketAddr, TcpStream>, connections: &mut HashMap<SocketAddr, Connection>, all_players: Vec<Player>, removed_player: Option<&Player>) {
  connection_streams.iter()
    ...
    .for_each(|x| {
      ...
      let _ = lib::utils::send_packet(x.1, lib::packets::clientbound::play::PlayerInfoRemove::get_id(), lib::packets::clientbound::play::PlayerInfoRemove {
        uuids: uuids_to_remove,
      }.try_into().unwrap());

      let _ = lib::utils::send_packet(x.1, lib::packets::clientbound::play::PlayerInfoUpdate::get_id(), lib::packets::clientbound::play::PlayerInfoUpdate {
        actions: 255,
      ...
      if removed_player.is_some() {
        let _ = lib::utils::send_packet(x.1, lib::packets::clientbound::play::RemoveEntities::get_id(), lib::packets::clientbound::play::RemoveEntities {
