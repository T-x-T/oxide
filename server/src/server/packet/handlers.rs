  ...
  pub fn acknowledge_finish_configuration(stream: &mut TcpStream, connections: &mut HashMap<SocketAddr, Connection>, game: &mut Game, connection_streams: &mut HashMap<SocketAddr, TcpStream>) -> bool {
    ...
    std::thread::spawn(move || {
      loop {
        ...
        lib::utils::send_packet(&stream_clone, lib::packets::clientbound::play::ClientboundKeepAlive::get_id(), lib::packets::clientbound::play::ClientboundKeepAlive {
...
pub fn update_players(connection_streams: &mut HashMap<SocketAddr, TcpStream>, connections: &mut HashMap<SocketAddr, Connection>, all_players: Vec<Player>, removed_player: Option<&Player>) {
  connection_streams.iter()
    ...
    .for_each(|x| {
      ...
      lib::utils::send_packet(x.1, lib::packets::clientbound::play::PlayerInfoRemove::get_id(), lib::packets::clientbound::play::PlayerInfoRemove {
        uuids: uuids_to_remove,
      }.try_into().unwrap());

      lib::utils::send_packet(x.1, lib::packets::clientbound::play::PlayerInfoUpdate::get_id(), lib::packets::clientbound::play::PlayerInfoUpdate {
        actions: 255,
      ...
      if removed_player.is_some() {
        lib::utils::send_packet(x.1, lib::packets::clientbound::play::RemoveEntities::get_id(), lib::packets::clientbound::play::RemoveEntities {
