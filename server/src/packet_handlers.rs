...
pub fn handle_packet(mut packet: lib::Packet, stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
  ...
  //println!("{}", packet.id);
    ...
    ConnectionState::Configuration => match packet.id {
      lib::packets::serverbound::configuration::ServerboundKnownPackets::PACKET_ID => configuration::serverbound_known_packets(stream, game),
      lib::packets::serverbound::configuration::AcknowledgeFinishConfiguration::PACKET_ID => configuration::acknowledge_finish_configuration(stream, game),
      _ => {Ok(None)},
    },
    ConnectionState::Play => match packet.id {
      ...
      lib::packets::serverbound::play::PlayerInput::PACKET_ID => play::player_input(stream, &mut packet.data, game),
      lib::packets::serverbound::play::Interact::PACKET_ID => play::interact(stream, &mut packet.data, game),
      _ => {Ok(None)},
		},
...
pub mod status {
  ...
  pub fn status_request(stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr().unwrap(), lib::packets::clientbound::status::StatusResponse::PACKET_ID, lib::packets::clientbound::status::StatusResponse {
      status: format!("{{
        \"version\": {{
  ...
  pub fn ping_request(data: &[u8], stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr().unwrap(), lib::packets::clientbound::status::PingResponse::PACKET_ID, lib::packets::clientbound::status::PingResponse {
...
pub mod login {
  ...
  pub fn login_start(data: &[u8], stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr()?, lib::packets::clientbound::login::LoginSuccess::PACKET_ID, lib::packets::clientbound::login::LoginSuccess {
  ...
  pub fn login_acknowledged(stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr()?, lib::packets::clientbound::configuration::ServerLinks::PACKET_ID, lib::packets::clientbound::configuration::ServerLinks {
   		links: vec![
...
use super::*;
  ...
  pub fn serverbound_known_packets(stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr()?, lib::packets::clientbound::configuration::FinishConfiguration::PACKET_ID, lib::packets::clientbound::configuration::FinishConfiguration {
  ...
  pub fn acknowledge_finish_configuration(stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&peer_addr, lib::packets::clientbound::play::SynchronizePlayerPosition::PACKET_ID, lib::packets::clientbound::play::SynchronizePlayerPosition {
    ...
    game.send_packet(&peer_addr, lib::packets::clientbound::play::GameEvent::PACKET_ID, lib::packets::clientbound::play::GameEvent {
      event: 13,
      value: 0.0,
    }.try_into()?);

    game.send_packet(&peer_addr, lib::packets::clientbound::play::SetContainerContent::PACKET_ID, lib::packets::clientbound::play::SetContainerContent {
	   	window_id: 0,
	    state_id: 1,
    ...
    for x in current_chunk_coords.x-lib::VIEW_DISTANCE as i32..=current_chunk_coords.x+lib::VIEW_DISTANCE as i32 {
      for z in current_chunk_coords.z-lib::VIEW_DISTANCE as i32..=current_chunk_coords.z+lib::VIEW_DISTANCE as i32 {
        new_player.send_chunk(&mut game.world.lock().unwrap(), x, z, &game.entity_id_manager, &game.block_state_data, game.clone())?;
      }
    }

    game.send_packet(&peer_addr, lib::packets::clientbound::play::SetHeldItem::PACKET_ID, lib::packets::clientbound::play::SetHeldItem {
    ...
    players.iter().for_each(|x| {
      ...
      game.send_packet(&x.peer_socket_address, lib::packets::clientbound::play::PlayerInfoUpdate::PACKET_ID, lib::packets::clientbound::play::PlayerInfoUpdate {
        actions: 255,
    ...
    for player in players.iter() {
      ...
      game.send_packet(&peer_addr, lib::packets::clientbound::play::SpawnEntity::PACKET_ID, lib::packets::clientbound::play::SpawnEntity {
      ...
      game.send_packet(&peer_addr, lib::packets::clientbound::play::SetEntityMetadata::PACKET_ID, lib::packets::clientbound::play::SetEntityMetadata {
        entity_id: player.entity_id,
        metadata: new_player_entity_metadata.clone(),
      }.try_into()?);

 	   	game.send_packet(&peer_addr, lib::packets::clientbound::play::SetEquipment::PACKET_ID, lib::packets::clientbound::play::SetEquipment {
	 			entity_id: player.entity_id,
	  		equipment: vec![
      ...
      game.send_packet(&peer_addr, lib::packets::clientbound::play::UpdateEntityRotation::PACKET_ID, lib::packets::clientbound::play::UpdateEntityRotation {
        entity_id: player.entity_id,
        on_ground: true, //add proper check https://git.thetxt.io/thetxt/oxide/issues/22
        yaw: player.get_yaw_u8(),
        pitch: player.get_pitch_u8(),
      }.try_into()?);
      game.send_packet(&peer_addr, lib::packets::clientbound::play::SetHeadRotation::PACKET_ID, lib::packets::clientbound::play::SetHeadRotation {
        entity_id: player.entity_id,
				head_yaw: player.get_yaw_u8(),
      }.try_into()?);
    }
    ...
    for player in players.iter() {
      ...
      game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::SpawnEntity::PACKET_ID, lib::packets::clientbound::play::SpawnEntity {
      ...
      game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::SetEntityMetadata::PACKET_ID, lib::packets::clientbound::play::SetEntityMetadata {
        entity_id: new_player_entity_id,
        metadata: new_player_entity_metadata.clone(),
      }.try_into()?);

	   	game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::SetEquipment::PACKET_ID, lib::packets::clientbound::play::SetEquipment {
	 			entity_id: new_player_entity_id,
	  		equipment: vec![
			...
			game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::UpdateEntityRotation::PACKET_ID, lib::packets::clientbound::play::UpdateEntityRotation {
        entity_id: player.entity_id,
        on_ground: true, //add proper check https://git.thetxt.io/thetxt/oxide/issues/22
        yaw: player.get_yaw_u8(),
        pitch: player.get_pitch_u8(),
      }.try_into()?);
      game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::SetHeadRotation::PACKET_ID, lib::packets::clientbound::play::SetHeadRotation {
        entity_id: player.entity_id,
  			head_yaw: player.get_yaw_u8(),
      }.try_into()?);
    }
    ...
    for entity in &game.world.lock().unwrap().dimensions.get("minecraft:overworld").unwrap().entities {
      game.send_packet(&peer_addr, lib::packets::clientbound::play::SpawnEntity::PACKET_ID, entity.to_spawn_entity_packet().try_into()?);
    ...
    game.send_packet(&peer_addr, lib::packets::clientbound::play::Commands::PACKET_ID, lib::packets::clientbound::play::Commands {
      nodes: crate::command::get_command_packet_data(game.clone()),
      root_index: 0,
    }.try_into()?);

    game.send_packet(&peer_addr, lib::packets::clientbound::play::SetTabListHeaderAndFooter::PACKET_ID, lib::packets::clientbound::play::SetTabListHeaderAndFooter {
...
pub mod play {
  ...
  pub fn player_action(data: &mut [u8], stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    game.send_packet(&stream.peer_addr()?, lib::packets::clientbound::play::AcknowledgeBlockChange::PACKET_ID, lib::packets::clientbound::play::AcknowledgeBlockChange {
  ...
  pub fn use_item_on(data: &mut [u8], stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    let blocks_to_place: Vec<(u16, BlockPosition)> = if block_type_at_location.has_right_click_behavior() && !player.is_sneaking() {
      ...
      block_interaction_result.handle(dimension, parsed_packet.location, player, &players_clone, block_id_at_location, game.clone())?
    } else {
      ...
      match world.dimensions.get_mut("minecraft:overworld").unwrap().overwrite_block(block_to_place.1, block_to_place.0, &game.block_state_data) {
        Ok(res) => {
          ...
          if block.block_type == data::blocks::Type::WallSign || block.block_type == data::blocks::Type::StandingSign || block.block_type == data::blocks::Type::WallHangingSign || block.block_type == data::blocks::Type::CeilingHangingSign {
            game.send_packet(&stream.peer_addr()?, lib::packets::clientbound::play::OpenSignEditor::PACKET_ID, lib::packets::clientbound::play::OpenSignEditor {
  ...
  pub fn chat_message(data: &mut[u8], game: Arc<Game>, stream: &mut TcpStream) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    for player in players.iter_mut() {
      ...
      game.send_packet(&player.peer_socket_address, lib::packets::clientbound::play::PlayerChatMessage::PACKET_ID, packet_to_send.clone().try_into()?);
    }
  ...
  pub fn chat_command(data: &mut[u8], stream: &mut TcpStream, game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>> {
    ...
    (command.execute)(parsed_packet.command, Some(stream), game)?;
  ...
  pub fn update_sign(data: &mut [u8], game: Arc<Game>) -> Result<Option<PacketHandlerAction>, Box<dyn Error>>{
    ...
    game.players.lock().unwrap().iter().for_each(|x| {
      game.send_packet(&x.peer_socket_address, lib::packets::clientbound::play::BlockEntityData::PACKET_ID, lib::packets::clientbound::play::BlockEntityData {
        location: parsed_packet.location,
