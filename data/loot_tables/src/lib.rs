...
pub fn get_loot_tables() -> HashMap<LootTableType, HashMap<&'static str, LootTable>> {
	let mut output: HashMap<LootTableType, HashMap<&'static str, LootTable>> = HashMap::new();

	let mut block: HashMap<&'static str, LootTable> = HashMap::new();
	block.insert(
		"minecraft:wheat",
		LootTable {
						...
						children: vec![
							LootTablePoolEntry::Singleton(LootTablePoolEntrySingleton {
								...
								conditions: vec![Predicate::BlockStateProperty(PredicateBlockStateProperty {
									...
									properties: vec![(Property::CropAge(::blocks::CropAge::Num7), Property::CropAge(::blocks::CropAge::Num7))],
								})],
								functions: vec![],
								weight: None,
								quality: None,
					...
					children: vec![
						...
						LootTablePoolEntry::Singleton(LootTablePoolEntrySingleton {
							...
							functions: vec![
								...
								ItemModifier::LimitCount(NumberProvider::Uniform(
									Box::new(NumberProvider::Constant(1.0)),
									Box::new(NumberProvider::Constant(4.0)),
								)),
	...
	output.insert(LootTableType::Block, block);
