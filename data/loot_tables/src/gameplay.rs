		...
		pools: vec![
			LootTablePool {
				...
				entries: vec![
					...
					conditions: vec![],
					functions: vec![
							ItemModifier::SetPotion("minecraft:water"),
					],
					weight: Some(10),
					quality: None,
					}),
			...
			LootTablePool {
				...
				entries: vec![
					...
					functions: vec![
							...
							ItemModifier::SetPotion("minecraft:harming"),
					],
					weight: None,
					quality: None,
					}),
					...
					functions: vec![
							...
							ItemModifier::SetPotion("minecraft:leaping"),
					],
					weight: None,
					quality: None,
					}),
					...
					functions: vec![
							...
							ItemModifier::SetPotion("minecraft:fire_resistance"),
					],
					weight: None,
					quality: None,
					}),
					...
					functions: vec![
							...
							ItemModifier::SetPotion("minecraft:invisibility"),
					],
					weight: None,
					quality: None,
					}),
					...
					functions: vec![
							...
							ItemModifier::SetPotion("minecraft:night_vision"),
					],
					weight: None,
					quality: None,
					}),
