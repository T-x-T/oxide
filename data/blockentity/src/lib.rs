...
pub fn get_block_entity_types() -> std::collections::HashMap<String, u8> {{
	...
	output.insert("minecraft:brushable_block".to_string(), 40);
	...
	output.insert("minecraft:test_block".to_string(), 45);
	output.insert("minecraft:test_instance_block".to_string(), 46);
	output.insert("minecraft:trapped_chest".to_string(), 2);
	output.insert("minecraft:trial_spawner".to_string(), 43);
