...
pub fn get_block_state_id(
	...
	output.push((
		block
			...
			.iter()
			.find(|x| {
				x.properties.contains(&Property::FenceGateFacing(facing.clone()))
	...
	mod interact {
		...
		fn open_north() {
			...
			let block_state_id_opened = block
				...
				.find(|x| {
					x.properties.contains(&Property::FenceGateFacing(FenceGateFacing::North))
						&& x.properties.contains(&Property::FenceGateInWall(FenceGateInWall::False))
						&& x.properties.contains(&Property::FenceGateOpen(FenceGateOpen::True))
						&& x.properties.contains(&Property::FenceGatePowered(FenceGatePowered::False))
				})
				.unwrap()
				.id;
		...
		fn open_south() {
			...
			let block_state_id_opened = block
				...
				.iter()
				.find(|x| {
					x.properties.contains(&Property::FenceGateFacing(FenceGateFacing::South))
						&& x.properties.contains(&Property::FenceGateInWall(FenceGateInWall::False))
						&& x.properties.contains(&Property::FenceGateOpen(FenceGateOpen::True))
						&& x.properties.contains(&Property::FenceGatePowered(FenceGatePowered::False))
				})
		...
		fn open_west() {
			...
			let block_state_id_opened = block
				...
				.iter()
				.find(|x| {
					x.properties.contains(&Property::FenceGateFacing(FenceGateFacing::West))
						&& x.properties.contains(&Property::FenceGateInWall(FenceGateInWall::False))
						&& x.properties.contains(&Property::FenceGateOpen(FenceGateOpen::True))
						&& x.properties.contains(&Property::FenceGatePowered(FenceGatePowered::False))
				})
