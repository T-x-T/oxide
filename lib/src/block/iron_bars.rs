...
mod test {
  ...
  mod get_block_state_id {
    ...
    fn no_connections() {
      ...
      let block_state_id = block.states.iter().find(|x| x.properties.contains(&Property::IronBarsNorth(IronBarsNorth::False)) && x.properties.contains(&Property::IronBarsSouth(IronBarsSouth::False)) && x.properties.contains(&Property::IronBarsEast(IronBarsEast::False)) && x.properties.contains(&Property::IronBarsWest(IronBarsWest::False)) && x.properties.contains(&Property::IronBarsWaterlogged(IronBarsWaterlogged::False))).unwrap().id;
