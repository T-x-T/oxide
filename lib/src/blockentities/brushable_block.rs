...
impl CommonBlockEntity for BrushableBlock {
...
impl From<BrushableBlock> for Vec<NbtTag> {
	fn from(_value: BrushableBlock) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for BrushableBlock {
