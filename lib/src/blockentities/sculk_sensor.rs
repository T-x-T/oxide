...
impl CommonBlockEntity for SculkSensor {
...
impl From<SculkSensor> for Vec<NbtTag> {
	fn from(_value: SculkSensor) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for SculkSensor {
