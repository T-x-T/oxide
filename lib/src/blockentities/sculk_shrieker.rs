...
impl CommonBlockEntity for SculkShrieker {
...
impl From<SculkShrieker> for Vec<NbtTag> {
	fn from(_value: SculkShrieker) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for SculkShrieker {
