...
impl CommonBlockEntity for TrialSpawner {
...
impl From<TrialSpawner> for Vec<NbtTag> {
	fn from(_value: TrialSpawner) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for TrialSpawner {
