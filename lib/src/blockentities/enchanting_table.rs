...
impl CommonBlockEntity for EnchantingTable {
...
impl From<EnchantingTable> for Vec<NbtTag> {
	fn from(_value: EnchantingTable) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for EnchantingTable {
