...
impl CommonBlockEntity for StructureBlock {
...
impl From<StructureBlock> for Vec<NbtTag> {
	fn from(_value: StructureBlock) -> Self {
		return Vec::new();
	}
}

impl TryFrom<NbtListTag> for StructureBlock {
