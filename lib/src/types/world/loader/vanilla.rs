  ...
  fn load_entities_in_chunk(&self, x: i32, z: i32, next_entity_id: &mut i32) -> Vec<Box<dyn SaveableEntity + Send>> {
    ...
    for entity in chunk_nbt.get_child("Entities").unwrap().as_list() {
      ...
      match entity_type {
        ...
        "minecraft:chest_minecart" => output.push(Box::new(crate::entity::ChestMinecart::from_nbt(entity, *next_entity_id))),
        ...
        "minecraft:donkey" => output.push(Box::new(crate::entity::Donkey::from_nbt(entity, *next_entity_id))),
        ...
        "minecraft:parrot" => output.push(Box::new(crate::entity::Parrot::from_nbt(entity, *next_entity_id))),
        "minecraft:pig" => output.push(Box::new(crate::entity::Pig::from_nbt(entity, *next_entity_id))),
