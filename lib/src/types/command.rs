...
impl From<ParserProperty> for i32 {
	fn from(value: ParserProperty) -> Self {
		return match value {
			...
			ParserProperty::HexColor => 17,
			ParserProperty::Component => 18,
			ParserProperty::Style => 19,
			ParserProperty::Message => 20,
			ParserProperty::Nbt => 21,
			ParserProperty::NbtTag => 22,
			ParserProperty::NbtPath => 23,
			ParserProperty::Objective => 24,
			ParserProperty::ObjectiveCriteria => 25,
			ParserProperty::Operation => 26,
			ParserProperty::Particle => 27,
			ParserProperty::Angle => 28,
			ParserProperty::Rotation => 29,
			ParserProperty::ScoreboardSlot => 30,
			ParserProperty::ScoreHolder(_) => 31,
			ParserProperty::Swizzle => 32,
			ParserProperty::Team => 33,
			ParserProperty::ItemSlot => 34,
			ParserProperty::ItemSlots => 35,
			ParserProperty::ResourceLocation => 36,
			ParserProperty::Function => 37,
			ParserProperty::EntityAnchor => 38,
			ParserProperty::IntRange => 39,
			ParserProperty::FloatRange => 40,
			ParserProperty::Dimension => 41,
			ParserProperty::Gamemode => 42,
			ParserProperty::Time(_) => 43,
			ParserProperty::ResourceOrTag(_) => 44,
			ParserProperty::ResourceOrTagKey(_) => 45,
			ParserProperty::Resource(_) => 46,
			ParserProperty::ResourceKey(_) => 47,
			ParserProperty::ResourceSelector(_) => 48,
			ParserProperty::TemplateMirror => 49,
			ParserProperty::TemplateRotation => 50,
			ParserProperty::Heightmap => 51,
			ParserProperty::LootTable => 52,
			ParserProperty::LootPredicate => 53,
			ParserProperty::LootModifier => 54,
			ParserProperty::Dialog => 55,
			ParserProperty::Uuid => 56,
		};
	}
}
