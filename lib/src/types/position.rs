...
impl From<BlockPosition> for EntityPosition {
	fn from(value: BlockPosition) -> Self {
		return Self { x: value.x as f64, y: value.y as f64, z: value.z as f64, yaw: 0.0, pitch: 0.0 };
	}
}

impl From<EntityPosition> for BlockPosition {
	fn from(value: EntityPosition) -> Self {
		return Self { x: value.x as i32, y: value.y as i16, z: value.z as i32 };
	}
}
...
impl std::ops::Sub for EntityPosition {
	...
	fn sub(self, rhs: Self) -> Self::Output {
		return Self { x: self.x - rhs.x, y: self.y - rhs.y, z: self.z - rhs.z, yaw: self.yaw - rhs.yaw, pitch: self.pitch - rhs.pitch };
	}
}
